...
* Create any number of galleries (album) for photos and videos;
* Support bulk/mass uploads and by drag & drop. Ability to upload one or multiple photos at once.
* SEO optimized landing page to display galleries and photos;
* Ability to set metadata (title, description, keyword, URL) per gallery page
* Ability to set a different photo name and description per store view
* Support gallery widgets for flexible placement and positioning;
* Support 2 gallery layouts:  "gallery with filters" and "gallery without filters"
* Support lightbox with thumbnails expands, closes, plays, and pauses gallery. 
* Support videos (Youtube & Vimeo) on a lightbox with thumbnails;
* Ability to restrict galleries/photos display per customer groups and store views;
* Mobile-friendly
* Support multiple-stores

<img src="https://www.ulmod.com/media/ulmod/product_content/gallery-img-min.png">
<img src="https://www.ulmod.com/media/ulmod/product_content/gallery-gal-min.png">
<img src="https://www.ulmod.com/media/ulmod/product_content/gallery-place-min.png">
